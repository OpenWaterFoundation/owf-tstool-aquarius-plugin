...
#
#     TSTool 15:
#       ./tstool/NN/plugins/owf-tstool-aquarius-plugin/1.2.3/
#
#     TSTool before version 15:
#       ./tstool/NN/plugins/owf-tstool-aquarius-plugin/
...
# - do this first because it is used by logging messages
configureEcho
...
mavenProjectFolder=${repoFolder}/owf-tstool-aquarius-plugin
...
devBinFolder="${repoFolder}/owf-tstool-aquarius-plugin/target/classes"
...
mainPluginFolder="${pluginsFolder}/owf-tstool-aquarius-plugin"

# Version installed folder for the plugin.
versionPluginFolder="${mainPluginFolder}/${pluginVersion}"

jarFile="${versionPluginFolder}/owf-tstool-aquarius-plugin-${pluginVersion}.jar"
manifestFile="${repoFolder}/owf-tstool-aquarius-plugin/src/main/resources/META-INF/MANIFEST.MF"
