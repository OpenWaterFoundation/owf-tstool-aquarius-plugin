...
#     tstool-aquarius-plugin-1.0.0-win-2206060102.zip
...
createPluginZipFile() {
  ...
  "${sevenzip}" a -tzip ${zipFile} "owf-tstool-aquarius-plugin/${pluginVersion}"
  exitStatus=$?
...
now=$(date +%Y%m%d%H%M)
zipFile="${distFolder}/tstool-aquarius-plugin-${pluginVersion}-win-${now}.zip"
