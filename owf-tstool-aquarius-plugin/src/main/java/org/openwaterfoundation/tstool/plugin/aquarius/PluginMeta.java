...
package org.openwaterfoundation.tstool.plugin.aquarius;

public class PluginMeta {
	/**
	 * Plugin version.
	 */
	public static final String VERSION = "1.0.0 (2025-09-30)";
	...
	public static String getDocumentationRootUrl() {
		...
		String url = "https://software.openwaterfoundation.org/tstool-aquarius-plugin/latest/doc-user/";
		return url;
	}
